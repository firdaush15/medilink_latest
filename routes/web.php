...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Pharmacy Inventory
    Route::get('/pharmacy-inventory', [AdminPharmacyController::class, 'index'])->name('pharmacy-inventory');
    Route::get('/pharmacy-inventory/{id}', [AdminPharmacyController::class, 'show'])->name('pharmacy-inventory.show');
    Route::get('/pharmacy-inventory-reports', [AdminPharmacyController::class, 'reports'])->name('pharmacy-inventory.reports');
    Route::get('/pharmacy-inventory-analytics', [AdminPharmacyController::class, 'analytics'])->name('pharmacy-inventory.analytics');
    Route::get('/pharmacy-inventory-export', [AdminPharmacyController::class, 'export'])->name('pharmacy-inventory.export');
...
Route::middleware(['auth', 'role:doctor'])->prefix('doctor')->name('doctor.')->group(function () {
    ...
    // Medications (read-only view for prescribing)
