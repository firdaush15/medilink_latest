...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/reports', fn () => view('admin.placeholder', ['title' => 'Reports & Analytics']))->name('reports');
    Route::get('/settings', fn () => view('admin.placeholder', ['title' => 'System Settings']))->name('settings');
});
...
Route::middleware(['auth', 'role:doctor'])->prefix('doctor')->name('doctor.')->group(function () {
    ...
    Route::get('/setting', fn () => view('doctor.placeholder', ['title' => 'Settings - Coming Soon']))->name('setting');
});
...
Route::middleware(['auth', 'role:receptionist'])->prefix('receptionist')->name('receptionist.')->group(function () {
    ...
    Route::get('/setting', fn () => view('receptionist.placeholder', ['title' => 'Settings']))->name('setting');
});
...
Route::middleware(['auth', 'role:nurse'])->prefix('nurse')->name('nurse.')->group(function () {
    ...
    // Alerts — specific routes BEFORE {id} routes
    ...
    Route::get('/settings', fn () => view('nurse.placeholder', ['title' => 'Settings - Coming Soon']))->name('settings');
});
...
Route::middleware(['auth', 'role:pharmacist'])->prefix('pharmacist')->name('pharmacist.')->group(function () {
    ...
    // ✅ RENAMED route still kept as 'resolve' for backwards compat with existing blade buttons
    ...
    Route::get('/setting', fn () => view('pharmacist.placeholder', ['title' => 'Settings - Coming Soon']))->name('setting');
});
