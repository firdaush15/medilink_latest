...
class CompleteTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($patientData as $data) {
            ...
            // 1. Create the Patient (REMOVE 'allergies' line from here)
            ...
            // 2. Create the Allergy Record linked to this patient
            // (Assuming you have an App\Models\PatientAllergy model)
