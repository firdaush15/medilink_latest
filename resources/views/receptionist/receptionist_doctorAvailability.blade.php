...
<head>
    ...
    @vite(['resources/css/sidebar.css', 'resources/css/receptionist/receptionist_doctorAvailability.css'])
</head>
<body>
    ...
    <div class="main-content">
        ...
        <div class="date-selector">
            ...
            <input type="date" id="selected-date" value="{{ $selectedDate }}" onchange="loadSchedule()">
