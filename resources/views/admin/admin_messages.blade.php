...
<head>
    ...
    @vite(['resources/css/sidebar.css', 'resources/css/admin/admin_messages.css'])
</head>
...
<body>
                ...
                <div class="chat-header">
                    <div class="chat-header-info">
                        <div class="doctor-info">
                            ...
                            <span id="recipientStatusBadge" class="status-badge {{ $selectedConversation->doctor->user->isOnline() ? 'online' : 'offline' }}">
    <i id="recipientStatusDot" class="fas fa-circle"></i>
    <span id="recipientStatusText">{{ $selectedConversation->doctor->user->isOnline() ? 'Online' : 'Offline' }}</span>
</span>
    ...
    <script>
(function () {
    const INBOX_POLL_URL      = '{{ route("admin.messages.inbox-poll") }}';
...
@if($selectedConversation)
  <script>
    window.POLL_URL        = '{{ route("admin.messages.poll", $selectedConversation->conversation_id) }}';
