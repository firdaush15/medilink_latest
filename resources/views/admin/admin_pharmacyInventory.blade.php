...
<head>
    ...
    <style>
        ...
        .movement-type-in { background: #c6f6d5; color: #22543d; }
        .movement-type-out { background: #bee3f8; color: #2c5282; }
        
        .quantity-positive { color: #22543d; font-weight: 600; }
        .quantity-negative { color: #c53030; font-weight: 600; }
    </style>
</head>
...
function applyFilters() {
    ...
    window.location.href = `{{ route('admin.pharmacy-inventory') }}?${params.toString()}`;
}

function clearFilters() {
    window.location.href = '{{ route('admin.pharmacy-inventory') }}';
}
