                ...
                <div class="form-group">
                    ...
                    <select name="medicine_id" id="medicineSelect" class="form-control" required onchange="updateMedicineInfo()">
                        ...
                        <option value="{{ $medicine->medicine_id }}"
                            ...
                            data-expiry="{{ $medicine->expiry_date->format('M d, Y') }}"
                    ...
                    <span class="help-text">Select from expired or near-expiry medicines</span>
                </div>
...
<div class="form-section" style="background: #fff3cd; padding: 20px; border: 2px solid #ffc107;">
    ...
    function updateMedicineInfo() {
        ...
        if (option.value) {
            ...
            console.log('✅ Parsed:', {currentStock, unitPrice});
    ...
    function calculateLoss() {
        ...
        console.log('=== calculateLoss ===', {quantity, currentStock, unitPrice});
