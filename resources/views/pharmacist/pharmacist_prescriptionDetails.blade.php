...
<body>
    <div class="container">
        ...
        <div class="prescription-section">
            ...
            <div class="medicine-item {{ $prescription->patient->hasDrugAllergy($item->medicine_name) ? 'has-allergy' : '' }}">
                <div class="medicine-name">
                    {{ $item->medicine_name }}
                    @if($prescription->patient->hasDrugAllergy($item->medicine_name))
                    <span style="color: #dc3545; font-size: 16px;">⚠️ ALLERGY ALERT</span>
                    @endif
                </div>
