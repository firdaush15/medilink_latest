...
<head>
    ...
    @vite(['resources/css/sidebar.css', 'resources/css/pharmacist/pharmacist_prescriptions.css'])
</head>
...
<body>
    ...
    <a href="{{ route('pharmacist.prescriptions.show', $dispensing->prescription_id) }}" class="btn btn-verify" style="background-color: #007bff; border-color: #007bff;">
        🔍 Review & Verify
    </a>
@else
