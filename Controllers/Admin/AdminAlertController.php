...
class AdminAlertController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Pass all staff lists for the Send Alert modal
        ...
        return view('admin.admin_alerts', compact(
            'alerts', 'filter', 'counts', 'search',
            'doctors', 'nurses', 'pharmacists', 'receptionists'
        ));
    }

    /**
     * Admin sends alert to any staff member (doctor, nurse, pharmacist, receptionist).
     */
    public function send(Request $request)
    {
        $validated = $request->validate([
            'recipient_id'   => 'required|exists:users,id',
            'recipient_type' => 'required|in:doctor,nurse,pharmacist,receptionist',
        ...
        // Verify the recipient user actually has the claimed role
