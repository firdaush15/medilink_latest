...
class DoctorPatientController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // ✅ SECURITY CHECK: Only show if doctor has appointments with this patient
        $patient = Patient::with([
            ...
            // ✅ NEW: Load mental health assessments
            'mentalHealthAssessments' => function ($q) {
                $q->with(['answers', 'reviewedByDoctor.user'])
    ...
    public function reviewMentalHealthAssessment(Request $request)
    {
        ...
        $assessment = MentalHealthAssessment::findOrFail($validated['assessment_id']);

        // ✅ SECURITY: Verify doctor has treated this patient
        $hasAccess = $assessment->patient->appointments()
        ...
        return redirect()->back()->with('success', 'Clinical review added successfully');
    }
