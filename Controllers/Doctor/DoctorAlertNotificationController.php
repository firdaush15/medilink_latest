...
class DoctorAlertNotificationController extends Controller
{
    ...
    public function outbox(Request $request)
    {
        ...
        // All staff types a doctor can alert
        ...
        return view('doctor.doctor_alertOutbox', compact(
            'sentAlerts', 'nurses', 'pharmacists', 'receptionists', 'adminUsers',
            'patients', 'stats', 'doctor'
        ));
    }

    /**
     * Send a new alert.
     * Doctor can send to: nurse, pharmacist, receptionist, admin.
     */
    public function send(Request $request)
    {
        $validated = $request->validate([
            'recipient_id'   => 'required|exists:users,id',
            'recipient_type' => 'required|in:nurse,pharmacist,receptionist,admin',
