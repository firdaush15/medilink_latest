...
class PharmacistInventoryController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('pharmacist.pharmacist_inventoryEdit', compact('medicine', 'categories', 'forms', 'recentMovements'));
    }
    ...
    public function stockHistory($id)
    {
        ...
        return view('pharmacist.pharmacist_inventoryStockHistory', compact('medicine', 'movements'));
    }
