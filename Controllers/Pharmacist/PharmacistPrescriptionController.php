...
class PharmacistPrescriptionController extends Controller
{
    ...
    public function verify(Request $request, $id)
    {
        try {
            ...
            foreach ($prescription->items as $item) {
                ...
                if ($matchingAllergies) { $hasAllergyWarnings = true; break; }
            }
    ...
    /**
     * ✅ NEW: Alert receptionist(s) that patient is ready for checkout after dispense
     */
    protected function alertReceptionistForCheckout($dispensing, $prescription, $totalAmount)
    {
        try {
            ...
            // Primary: alert the receptionist who checked in this patient
            if ($appointment && $appointment->checked_in_by) {
                StaffAlert::create([
                    'sender_id'       => auth()->id(),
                    'sender_type'     => 'pharmacist',
                    'recipient_id'    => $appointment->checked_in_by,
                ...
                // Fallback: alert ALL receptionists
