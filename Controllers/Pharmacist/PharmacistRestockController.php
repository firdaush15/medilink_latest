...
class PharmacistRestockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // ✅ FIXED: Dynamically resolve admin instead of hardcoding recipient_id => 1
        ...
        foreach ($adminUsers as $adminUser) {
            StaffAlert::create([
                ...
                'alert_message'  => "Pharmacist {$pharmacist->user->name} requests {$validated['quantity_requested']} units of {$medicine->medicine_name}. Justification: {$validated['justification']}",
