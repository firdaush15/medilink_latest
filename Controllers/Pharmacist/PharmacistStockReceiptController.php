...
class PharmacistStockReceiptController extends Controller
{
    ...
    {
        // ✅ FIXED: Changed validation rules for checkboxes
        $validated = $request->validate([
            ...
            'manufacture_date' => 'nullable|date|before_or_equal:today', // ✅ Changed from 'before:today'
            'expiry_date' => 'required|date|after:today',
            'supplier' => 'required|string|max:255',
            'supplier_invoice_number' => 'nullable|string|max:100',
            'unit_price' => 'required|numeric|min:0',
            'quality_check_notes' => 'nullable|string|max:1000',
            // ✅ FIXED: Changed from 'required|boolean' to 'nullable|in:0,1'
        ...
        // Quality check: Ensure expiry is at least 1 year from now
