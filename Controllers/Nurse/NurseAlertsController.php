...
class NurseAlertsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Doctors the nurse can alert (for the send-to-doctor modal)
        ...
        return view('nurse.nurse_alerts', compact('alerts', 'filter', 'counts', 'doctors', 'recentPatients'));
    }

    /**
     * ✅ NEW: Soft-poll endpoint — returns unread + critical counts only.
     * Called every 30 s from the blade instead of full page reload.
     */
    ...
    /**
     * ✅ NEW: Nurse sends an alert to a doctor.
     */
