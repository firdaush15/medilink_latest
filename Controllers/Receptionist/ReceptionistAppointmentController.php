...
class ReceptionistAppointmentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $doctors  = Doctor::with('user')->where('availability_status', 'Available')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ...
                ->with('success', 'Appointment scheduled successfully! ID: ' . $appointment->appointment_id);
    ...
    // ✅ NOTE: cancel() is intentionally NOT here.
    // Appointments are cancelled by the PATIENT via the mobile app
    // (Api/AppointmentController@cancelAppointment).
    // That endpoint handles alerting the doctor and receptionists.
    // Receptionists view appointment status but do not cancel appointments.
}