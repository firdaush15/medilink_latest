...
class ReceptionistAlertController extends Controller
{
    public function index(Request $request)
    {
        ...
        // ✅ Staff lists for Send Alert modal
        ...
        return view('receptionist.receptionist_alerts', compact(
            ...
            'doctors', 'nurses', 'adminUsers'
        ));
    }

    /**
     * ✅ NEW: Receptionist sends alert to doctor, nurse, or admin
     */
    public function send(Request $request)
    {
        $validated = $request->validate([
            'recipient_id'   => 'required|exists:users,id',
            'recipient_type' => 'required|in:doctor,nurse,admin',
